---
title: <i class="fa-solid fa-scroll title-fa"></i>Code of conduct
---
...
[Murilo Henrique Moreira]({{ site["pt/team/index"].path|relative_to(page.path) }}#MuriloHMoreira)
immediately.

For official concerns or if Murilo is the cause of your concern, please
contact [Ouvidoria UFSCar](https://www.ouvidoria.ufscar.br/pt-br).

## Credit

This Code of Conduct was adapted from
[Computer-Oriented Geoscience Lab Code of Conduct](https://www.compgeolab.org/manual/coc.html), which is licensed
